...
## Project Structure
    ...
    ├── appfromtemplate_37589  # Django project configurations
...
1. Clone this repo and `cd appfromtemplate_37589`
...
2. Clone this repo and `cd appfromtemplate_37589`
